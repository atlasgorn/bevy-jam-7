...
You navigate around the location, solve the first 1-2 simple puzzles (find something, bring it somewhere) or maybe find numerical password and enter it somewhere. After this first quest you will find "Puppy". When you approach it and try to caress it it turns into a katana type sword.   
Then you will encounter your first enemies which you will have to defeat to move on.   
